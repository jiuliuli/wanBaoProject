  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.welcome}>
        ...
        >{`${year}年${month}月${day}日 星期${weekDay}`}</Text>
        ...
        <>
                  ...
                  <div className={styles.legend}>
                    <div className={styles.legendItem}>
                      <span
                        ...
                        style={{ backgroundColor: totalState.value.flowTaskData.waiting.color }}
                      ></span>
                      <span>待审</span>
                    </div>
                    <div className={styles.legendItem}>
                      <span
                        className={styles.legendColor}
                        style={{ backgroundColor: totalState.value.flowTaskData.completed.color }}
                      ></span>
                      <span>已审</span>
                    </div>
                    <div className={styles.legendItem}>
                      <span
                        className={styles.legendColor}
                        style={{ backgroundColor: totalState.value.flowTaskData.inProgress.color }}
                      ></span>
                      <span>待阅</span>
                    </div>
                  </div>
                ...
                <div className={styles.pieChart}>
                  ...
                  <div className={styles.legend}>
                    <div className={styles.legendItem}>
                      <span
                        className={styles.legendColor}
                        style={{ backgroundColor: totalState.value.projectData.waiting.color }}
                      ></span>
                      <span>待审</span>
                    </div>
                    <div className={styles.legendItem}>
                      <span
                        className={styles.legendColor}
                        style={{ backgroundColor: totalState.value.projectData.completed.color }}
                      ></span>
                      <span>完成</span>
                    </div>
                    <div className={styles.legendItem}>
                      <span
                        className={styles.legendColor}
                        style={{ backgroundColor: totalState.value.projectData.inProgress.color }}
                      ></span>
                      <span>进行中</span>
                    </div>
                    <div className={styles.legendItem}>
                ...
                <div className={styles.barChart}>
                  ...
                  <div className={styles.barContainer}>
                    <div
                      ...
                      style={{
                        height: `${totalState.value.financeData.expense.value}%`,
                    ...
                    <div
                      className={styles.bar}
                      style={{
                        height: `${totalState.value.financeData.income.value}%`,
                    ...
                    <div
                      className={styles.bar}
                      style={{
                        height: `${totalState.value.financeData.pending.value}%`,
          ...
          <Row gutter={24} style={{ marginTop: 24 }}>
            <Col span={12}>
              ...
              >
                <div className={styles.newsList}>资讯资讯</div>
              </Card>
            </Col>
            <Col span={12}>
              <Card
              ...
              >
                <div className={styles.newsList}>{/* 这里可以放政策法规列表内容 */}</div>
              </Card>
            </Col>
          </Row>
        </>
