...
import SalaryPayForm from './children/SalaryPayForm';
                ...
                <Tabs.TabPane tab="人员基本信息" key="basic">
                    {
                        (userInfo.value || type === 'create') && (
                            <BasicInfoForm data={type === 'create' ? {} : userInfo?.value[0]} type={type}
                    ...
                    valid && (
                        <>
                            <Tabs.TabPane tab="持证人员证书管理" key="certificate">
                                <CertificateInfoForm data={type === 'create' ? {} : certificateState?.value[0]} type={type} userName={userName} onNext={() => {
