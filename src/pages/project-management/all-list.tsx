                ...
                <SearchForm
                    ...
                    columns={[
                        ...
                        },
                        {
                            ...
                            title: "行业类型",
                            valueType: 'select',
                            options: industryListState.value?.map((item: any) => item.industryType).map((item: any) => ({ label: item, value: item })),
                        },
                        {
                            name: "source",
                            title: "项目来源",
                ...
                industryListState.value && (
                    <div className={styles.table}>
                        <Table
                            ...
                            columns={getColumns(industryListState.value.map((item: any) => item.industryType), evaluateTypeState.value) as any}
                            {...state.value}
                            scroll={{ x: 1000 }}
                            pagination={{
