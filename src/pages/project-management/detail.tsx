...
import { ArchiveInfoVO, BasicInfoVO, MaterialInfoVO, MemberInfoVO, RiskInfoVO } from "@/types/project.types";
...
export default function ProjectManagementDetail() {
    ...
    return (
        projectState.value && !projectState.loading && memberState.value && !memberState.loading && contractState.value && !contractState.loading &&
        <PageHeader
            ...
            <Tabs defaultActiveKey="basic"
                items={[
                    ...
                    },
                    {
                        label: '合同',
                        key: 'contract',
                        children: <ContractInfo data={contractState.value[0] as ContractDataType} />,
                    },
                    {
                        label: '流程',
                        key: 'process',
                        children: <ProcessInfo data={projectState.value?.process as BasicInfoVO} />,
                    },
                    {
                        label: "项目组成员",
                        key: "member",
