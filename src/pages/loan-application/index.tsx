...
const getColumns = (navigate: (path: string) => void) => [
  ...
  },
  {
    ...
    render: (text: any, record: any) => (
      <Button type="link" onClick={() => navigate(PATH_ENUM.LOAN_APPLICATION_EDIT.replace(':id', record.loanNumber))}>编辑</Button>
    ),
  },
];
...
const LoanApplication: React.FC = () => {
  ...
  return (
    <>
      <PageHeader title={'借款申请列表'} style={{ background: '#ffffff' }} extra={[
        <Button
          key="create"
          type="primary"
